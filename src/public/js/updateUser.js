...
function updateUserInfo() {
    ...
    $("#input-change-username").bind("change",function(){
        ...
        if (!regexUsername.test(username) || username.length < 3 || username.length > 17) {
            alertify.notify("Tên người dùng giới hạn trong khoảng 3-17 kí tự và không được chứa kí tự đặc biệt.","error",7);
    ...
    $("#input-change-address").bind("change",function(){
        ...
        if(address.length < 5 || address.length > 30){
            alertify.notify("Địa chỉ giới hạn trong khoảng 5-30 kí tự.","error",7);
    ...
    $("#input-change-phone").bind("change",function(){
        ...
        if (!regexPhone.test(phone)) {
            alertify.notify("Số điện thoại Việt Nam bắt đầu bằng số 0, từ 10-11 số.","error",7);
    ...
    $("#input-change-current-password").bind("change",function(){
        ...
        if (!regexPassword.test(currentPassword)) {
            alertify.notify("Phải chứa ít nhất 8 kí tự bao gồm chữ thường,chữ hoa, số và kí tự đặc biệt ","error",7);
            $(this).val(null);
    ...
    $("#input-change-confirm-new-password").bind("change",function(){
        ...
        if(!userUpdatePassword.newPassword){
            alertify.notify("Bạn chưa nhập lại mật khẩu mới !","error",7);
            $(this).val(null);
